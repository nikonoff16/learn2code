...
#    coders_count = str(coders_count)
    if  len(coders_count) == 2:
        if int(coders_count[-2:-1]) == 11 :
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 12:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 13:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 14:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 15:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 16:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 17:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 18:
            print(coders_count + ' программистов')
        elif int(coders_count[-2:-1]) == 19:
            print(coders_count + ' программистов')
        else:
            if index == 1:
