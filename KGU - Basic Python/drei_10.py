...
# Эта функциональность включается только в том случае, если не нужна расположенная с 5 по 13 строки
...
for lst in list_of_numberlists:
    if what_number in lst:
        number_count += 1
# Контроль правильного представления слова в финальной строке скрипта
